...
import { PropertyListComponentF } from '../property/property-list/property-list.component';
import { CarPropertyFormComponentF } from '../property/car-property-form/car-property-form.component';
import { ResidencePropertyFormComponentF } from '../property/residence-property-form/residence-property-form.component';
import { LifePropertyFormComponentF } from '../property/life-property-form/life-property-form.component';
import { TravelPropertyFormComponentF } from '../property/travel-property-form/travel-property-form.component';
import { CommercialPropertyFormComponentF } from '../property/commercial-property-form/commercial-property-form.component';
...
@Component({
  ...
  imports: [
    ...
    ReactiveFormsModule,
    FormsModule,
    PropertyListComponentF,
    // Import your new child components
    CarPropertyFormComponentF,
    ResidencePropertyFormComponentF,
    LifePropertyFormComponentF,
    TravelPropertyFormComponentF,
    CommercialPropertyFormComponentF,
    HeaderFrontComponent
],
  templateUrl: './properties.component.html',
  styleUrls: ['./properties.component.scss'],
})
export class PropertiesComponentF implements OnInit {
  propertyForm!: FormGroup;
   ...
   submitForm(): void {
     ...
     if (this.isEditMode && this.propertyId) {
       ...
       this.propertyService.updateProperty(this.propertyId, propertyData, this.selectedFiles).subscribe(
         () => {
           this.router.navigate(['/propertiesF']);
         },
         (error) => {
   ...
   cancel(): void {
     this.router.navigate(['/propertiess']);
   }
   ...
   editProperty(id: number) {
     this.router.navigate([`/propertiess/edit/${id}`]);
   }
