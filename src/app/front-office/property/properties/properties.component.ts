...
import { PropertyListComponentF } from '../property-list/property-list.component';
import { CarPropertyFormComponentF } from '../car-property-form/car-property-form.component';
import { ResidencePropertyFormComponentF } from '../residence-property-form/residence-property-form.component';
import { LifePropertyFormComponentF } from '../life-property-form/life-property-form.component';
import { TravelPropertyFormComponentF } from '../travel-property-form/travel-property-form.component';
import { CommercialPropertyFormComponentF } from '../commercial-property-form/commercial-property-form.component';
...
@Component({
  ...
  imports: [
    ...
    LeafletModule,HeaderFrontComponent
  ],
  templateUrl: './properties.component.html',
  styleUrls: ['./properties.component.scss'],
})
export class PropertiessComponent implements OnInit {
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          if (this.map && this.mainMarker) {
            const newPosition = latLng(currentLat, currentLng);
            this.mainMarker.setLatLng(newPosition);
            this.map.setView(newPosition, this.map.getZoom());
          }
        },
