...
import { PropertySlideshowComponent } from "../property-slideshow/property-slideshow.component";
import { QRCodeComponent } from 'angularx-qrcode';
import { PropertyCollageComponentF } from "../../../../front-office/property/property-collage/property-collage.component";
import { SlideshowVideoDownloadComponentF } from "../../../../front-office/property/slideshow-video/slideshow-video.component";

@Component({
  selector: 'app-property-list',
  standalone: true,
  imports: [CommonModule, RouterModule, PropertySlideshowComponent, QRCodeComponent, PropertyCollageComponentF, SlideshowVideoDownloadComponentF],
